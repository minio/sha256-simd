TEXT ·sha256_x16_avx512(SB), 7, $0
	...
	MOVQ mask_len+24(FP), SI
	MOVQ r14+16(FP), R13
	MOVQ (R13), R14
	LONG $0x92fbc1c4; BYTE $0xce // kmovq k1, r14
	LEAQ inputs+40(FP), AX
...
lloop:
	...
	LONG $0x487ed162; WORD $0x047f; BYTE $0x24 // vmovdqu32 [r12+64*0], zmm0
	QUAD $0x01244c7f487ed162 // vmovdqu32 [r12+64*1], zmm1
	QUAD $0x0224547f487ed162 // vmovdqu32 [r12+64*2], zmm2
	QUAD $0x03245c7f487ed162 // vmovdqu32 [r12+64*3], zmm3
	QUAD $0x0424647f487ed162 // vmovdqu32 [r12+64*4], zmm4
	QUAD $0x05246c7f487ed162 // vmovdqu32 [r12+64*5], zmm5
	QUAD $0x0624747f487ed162 // vmovdqu32 [r12+64*6], zmm6
	QUAD $0x07247c7f487ed162 // vmovdqu32 [r12+64*7], zmm7
...
skipNext14:
	...
	LONG $0x487c4162; WORD $0x3c10; BYTE $0x09 // vmovups zmm31, [r9+rcx]
skipNext15:
	LONG $0x487e7162; WORD $0xd86f // vmovdqu32 zmm11, zmm0
	LONG $0x487ed162; WORD $0x046f; BYTE $0x24 // vmovdqu32 zmm0, [r12+64*0]
	LONG $0x497dd162; WORD $0xc3fe // vpaddd zmm0{k1}, zmm0, zmm11
	LONG $0x487e7162; WORD $0xd96f // vmovdqu32 zmm11, zmm1
	QUAD $0x01244c6f487ed162 // vmovdqu32 zmm1, [r12+64*1]
	LONG $0x4975d162; WORD $0xcbfe // vpaddd zmm1{k1}, zmm1, zmm11
	LONG $0x487e7162; WORD $0xda6f // vmovdqu32 zmm11, zmm2
	QUAD $0x0224546f487ed162 // vmovdqu32 zmm2, [r12+64*2]
	LONG $0x496dd162; WORD $0xd3fe // vpaddd zmm2{k1}, zmm2, zmm11
	LONG $0x487e7162; WORD $0xdb6f // vmovdqu32 zmm11, zmm3
	QUAD $0x03245c6f487ed162 // vmovdqu32 zmm3, [r12+64*3]
	LONG $0x4965d162; WORD $0xdbfe // vpaddd zmm3{k1}, zmm3, zmm11
	LONG $0x487e7162; WORD $0xdc6f // vmovdqu32 zmm11, zmm4
	QUAD $0x0424646f487ed162 // vmovdqu32 zmm4, [r12+64*4]
	LONG $0x495dd162; WORD $0xe3fe // vpaddd zmm4{k1}, zmm4, zmm11
	LONG $0x487e7162; WORD $0xdd6f // vmovdqu32 zmm11, zmm5
	QUAD $0x05246c6f487ed162 // vmovdqu32 zmm5, [r12+64*5]
	LONG $0x4955d162; WORD $0xebfe // vpaddd zmm5{k1}, zmm5, zmm11
	LONG $0x487e7162; WORD $0xde6f // vmovdqu32 zmm11, zmm6
	QUAD $0x0624746f487ed162 // vmovdqu32 zmm6, [r12+64*6]
	LONG $0x494dd162; WORD $0xf3fe // vpaddd zmm6{k1}, zmm6, zmm11
	LONG $0x487e7162; WORD $0xdf6f // vmovdqu32 zmm11, zmm7
	QUAD $0x07247c6f487ed162 // vmovdqu32 zmm7, [r12+64*7]
	LONG $0x4945d162; WORD $0xfbfe // vpaddd zmm7{k1}, zmm7, zmm11
	LONG $0x92fbc1c4; BYTE $0xce // kmovq k1, r14
	JMP lloop
lastLoop:
	LONG $0x48455162; WORD $0xc4fe // vpaddd zmm8, zmm7, zmm12

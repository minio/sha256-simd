...
/*
DATA K<>+0x00(SB)/4, $0xe9b5dba5
DATA K<>+0x04(SB)/4, $0xb5c0fbcf
DATA K<>+0x08(SB)/4, $0x71374491
DATA K<>+0x0c(SB)/4, $0x428a2f98

DATA K<>+0x10(SB)/4, $0xab1c5ed5
DATA K<>+0x14(SB)/4, $0x923f82a4
DATA K<>+0x18(SB)/4, $0x59f111f1
DATA K<>+0x1c(SB)/4, $0x3956c25b

DATA K<>+0x20(SB)/4, $0x550c7dc3
DATA K<>+0x24(SB)/4, $0x243185be
DATA K<>+0x28(SB)/4, $0x12835b01
DATA K<>+0x2c(SB)/4, $0xd807aa98

DATA K<>+0x30(SB)/4, $0xc19bf174
DATA K<>+0x34(SB)/4, $0x9bdc06a7
DATA K<>+0x38(SB)/4, $0x80deb1fe
DATA K<>+0x3c(SB)/4, $0x72be5d74

DATA K<>+0x40(SB)/4, $0x240ca1cc
DATA K<>+0x44(SB)/4, $0x0fc19dc6
DATA K<>+0x48(SB)/4, $0xefbe4786
DATA K<>+0x4c(SB)/4, $0xe49b69c1

DATA K<>+0x50(SB)/4, $0x76f988da
DATA K<>+0x54(SB)/4, $0x5cb0a9dc
DATA K<>+0x58(SB)/4, $0x4a7484aa
DATA K<>+0x5c(SB)/4, $0x2de92c6f

DATA K<>+0x60(SB)/4, $0xbf597fc7
DATA K<>+0x64(SB)/4, $0xb00327c8
DATA K<>+0x68(SB)/4, $0xa831c66d
DATA K<>+0x6c(SB)/4, $0x983e5152

DATA K<>+0x70(SB)/4, $0x14292967
DATA K<>+0x74(SB)/4, $0x06ca6351
DATA K<>+0x78(SB)/4, $0xd5a79147
DATA K<>+0x7c(SB)/4, $0xc6e00bf3

DATA K<>+0x80(SB)/4, $0x53380d13
DATA K<>+0x84(SB)/4, $0x4d2c6dfc
DATA K<>+0x88(SB)/4, $0x2e1b2138
DATA K<>+0x8c(SB)/4, $0x27b70a85

DATA K<>+0x90(SB)/4, $0x92722c85
DATA K<>+0x94(SB)/4, $0x81c2c92e
DATA K<>+0x98(SB)/4, $0x766a0abb
DATA K<>+0x9c(SB)/4, $0x650a7354

DATA K<>+0xa0(SB)/4, $0xc76c51a3
DATA K<>+0xa4(SB)/4, $0xc24b8b70
DATA K<>+0xa8(SB)/4, $0xa81a664b
DATA K<>+0xac(SB)/4, $0xa2bfe8a1

DATA K<>+0xb0(SB)/4, $0x106aa070
DATA K<>+0xb4(SB)/4, $0xf40e3585
DATA K<>+0xb8(SB)/4, $0xd6990624
DATA K<>+0xbc(SB)/4, $0xd192e819

DATA K<>+0xc0(SB)/4, $0x34b0bcb5
DATA K<>+0xc4(SB)/4, $0x2748774c
DATA K<>+0xc8(SB)/4, $0x1e376c08
DATA K<>+0xcc(SB)/4, $0x19a4c116

DATA K<>+0xd0(SB)/4, $0x682e6ff3
DATA K<>+0xd4(SB)/4, $0x5b9cca4f
DATA K<>+0xd8(SB)/4, $0x4ed8aa4a
DATA K<>+0xdc(SB)/4, $0x391c0cb3

DATA K<>+0xe0(SB)/4, $0x8cc70208
DATA K<>+0xe4(SB)/4, $0x84c87814
DATA K<>+0xe8(SB)/4, $0x78a5636f
DATA K<>+0xec(SB)/4, $0x748f82ee

DATA K<>+0xf0(SB)/4, $0xc67178f2
DATA K<>+0xf4(SB)/4, $0xbef9a3f7
DATA K<>+0xf8(SB)/4, $0xa4506ceb
DATA K<>+0xfc(SB)/4, $0x90befffa
*/
GLOBL K<>(SB), RODATA|NOPTR, $256

DATA SHUF_MASK<>+0x00(SB)/8, $0x0405060700010203
DATA SHUF_MASK<>+0x08(SB)/8, $0x0c0d0e0f08090a0b
//DATA SHUF_MASK<>+0x00(SB)/8, $0x08090a0b0c0d0e0f
//DATA SHUF_MASK<>+0x08(SB)/8, $0x0001020304050607
...
PSHUFD $0x4e, X0, X0
    LONG $0xd3cb380f                           // SHA256RNDS2 XMM2, XMM3
////    LONG $0xcc380f45; BYTE $0xc1               // SHA256MSG1 XMM4, XMM5
...
PSHUFD $0x4e, X0, X0
    LONG $0xd3cb380f                           // SHA256RNDS2 XMM2, XMM3
////    LONG $0xcc380f45; BYTE $0xca               // SHA256MSG1 XMM5, XMM6
...
PADDL X7, X0
    LONG $0xdacb380f                           // SHA256RNDS2 XMM3, XMM2
////MOVO X7, X1
////    LONG $0x3a0f4566; WORD $0xe20f; BYTE $0x04 // PALIGNR XMM1, XMM6, 4
////PADDL X1, X4
////    LONG $0xcd380f45; BYTE $0xc3               // SHA256MSG2 XMM4, XMM7
PSHUFD $0x4e, X0, X0
    LONG $0xd3cb380f                           // SHA256RNDS2 XMM2, XMM3
////    LONG $0xcc380f45; BYTE $0xd3               // SHA256MSG1 XMM6, XMM7
...
//[A,B,C,D] / [E,F,G,H] = DCBA/HGFE => FBEA/HDGC = [A,E,B,F] / [C,G,D,H]
//[A,E,B,F] / [C,G,D,H] = FBEA/HDGC => FEBA/HGDC = [A,B,E,F] / [C,D,G,H]
//3120 = 0xd8

//[A,B,C,D] / [E,F,G,H] = DCBA/HGFE => FBEA/HDGC = [A,E,B,F] / [C,G,D,H]
//[A,E,B,F] / [C,G,D,H] = FBEA/HDGC => ABEF/CDGH = [F,E,B,A] / [H,G,D,C]
//0213 = 0x27
